...
flight = Element('adm_005')
flightvalue = ElementValue('admValue_005')

@allure.feature("TC(adm)-005 Manage new external user account creation")
class TestAdm005:
    ...
    @allure.story("Manage new external user account creation")
    def test_005(self, drivers):
        ...
        sleep(1)
        login.input_text(flight['Post'], flightvalue['Post'])
        sleep(1)
