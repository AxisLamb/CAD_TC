...
@allure.feature("TC(ECE)-041 03Check_Message_By_Operator")
class TestCheckMessageByOperator:
    ...
    def test_001(self, drivers):
        ...
        sleep(10)
        # 检查查询结果
        assert drivers.find_element_by_xpath("//*[@id='test0']/a/span").text == str(refno)
        # 进入详情页
        ...
        assert drivers.find_element_by_xpath("//*[@id='app']/div/div/section/div/div[1]/form/div/div[1]/div/div/form/div[1]/div[2]/div/div").text == 'Approved'
        login.is_click(flight["Logout"])
        login.is_click(flight["Logout_Yes"])
        current_path = os.path.abspath(__file__)
        # 清空文件内容
