...
flight = Element('messflight_004')
flightvalue = ElementValue('messFlightValue_004')
...
if __name__ == '__main__':
    pytest.main(['TestCase/TC_MESS_004/test_maintain_processing_deadline.py'])
