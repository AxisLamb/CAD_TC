...
flight = Element('user_002')
flightValue = ElementValue('userValue_002')
accountValue = ElementValue('cad_account')

@allure.feature("[TC(user)-002]Maintain User Account (Create, Search, Update) (Foreign Operator)")
class TestUserAccount:
    ...
    @allure.story("Maintain User Account (Create, Search, Update) (Foreign Operator)")
    def test_user_002(self, drivers):
        login = LoginPage(drivers)
        ...
        login.is_click(flight['External'])
        # 用户名
        ...
        drivers.find_element_by_xpath("//*[@id='app']/div/div/section/div/form/div[1]/div[2]/div/div[2]/div/div/div/div[1]/input").send_keys(Keys.ENTER)
        login.is_click(flight['Operator_Nationality'])
        login.input_text(flight['Operator_Nationality'], flightValue['Operator_Nationality'])
        drivers.find_element_by_xpath("//*[@id='app']/div/div/section/div/form/div[1]/div[2]/div/div[4]/div/div/div/div[1]/input").send_keys(Keys.ENTER)
        ...
        sleep(1)
        # 密码
        password = drivers.find_element_by_xpath("/html/body/div[4]/div/div[2]/div[1]/div[2]/p").text
        # log.info("----------------------------" + password)
        ...
        login.is_click(flight['External2'])
...
if __name__ == '__main__':
    pytest.main(['TestCase/TC_USER_002/test_user_002.py'])
